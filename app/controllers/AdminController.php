...
class AdminController extends BaseController {
	...
	if(Request::ajax()) {
	    ...
	    $sistemProsedur = DAL_SistemDanProsedur::getMonthlyCount();
	    $analisisJabatan = DAL_AnalisisJabatan::getMonthlyCount();
	    ...
	    foreach($sistemProsedur->get() as $obj)
		$data["sistem_dan_prosedur"][] = intval($obj->jumlah);

	    foreach($analisisJabatan->get() as $obj)
