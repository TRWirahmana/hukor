...
{{ Form::open(array('route' => 'proses_update_analisis_jabatan', 'method' => 'post', 'files' => true, 'class' => 'form form-horizontal')) }}
...
<div class="form-actions">
    <a href="{{ URL::route('index_analisis_jabatan') }}" class="btn">Batal</a>
