    ...
    <div class="row-fluid">
        <div class="span12">
            <fieldset>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        {{ Form::text('penanggungJawab[nama]', $user->pengguna->nama_lengkap, array('placeholder' => 'Masukan nama lengap...')) }}
                    </div>
                </div>
		...
		<div class="control-group">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        {{ Form::text('penanggungJawab[telp_kantor]', $user->pengguna->tlp_kantor, array('placeholder' => 'Masukan no telepon kantor...')) }}
                    </div>
                </div>
