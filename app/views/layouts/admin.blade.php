    ...
    <ul class="nav nav-tabs nav-stacked">
          ...
          <li id="app_forum">
            <a href="#">
              <label for="cbox-forum">
                <input {{ (null != AppConfig::find('enable_forum') && AppConfig::find('enable_forum')->value == 'true')?
                'checked': '' }} type="checkbox" id="cbox-forum" value="y" class="checkbox">
                &nbsp;&nbsp;&nbsp; Aktifkan Forum
              </label>
            </a>
          </li>
      ...
      <li class="dropdown">
        <ul id="menu_berita">
          ...
          <li><a href="{{URL::route('admin.categories.index')}}"><span class="rulycon-newspaper"></span> Kategori Berita</a>
          </li>
        </ul>
      </li>
      ...
      <li class="dropdown">
        <ul id="manage-menu">
          ...
          <li id="kelola_submenu"><a href="{{URL::to('admin/index_submenu')}}"><span class="rulycon-settings"></span>
              Kelola Submenu</a></li>
          <li id="layanan"><a href="{{URL::to('admin/layanan')}}"><span class="rulycon-settings"></span> Kelola Konten
              Layanan</a></li>
          <li id="layanan"><a href="{{URL::to('admin/editcallcenter')}}"><span class="rulycon-settings"></span> Kelola
              Kontak Kami</a></li>
          <li id="layanan"><a href="{{URL::to('admin/linked')}}"><span class="rulycon-settings"></span> Kelola Link
              Dikbud</a></li>
        </ul>
      </li>
